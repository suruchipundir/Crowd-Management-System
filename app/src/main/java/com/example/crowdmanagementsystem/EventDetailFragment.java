...
public class EventDetailFragment extends Fragment {
    ...
    /*public void onCountButtonClicked(View view){
        Intent intent = new Intent(getActivity().getApplicationContext(), Count.class);
        startActivity(intent);
    }

    public void onBehaviorButtonClicked(View view){
        Intent intent = new Intent(getActivity().getApplicationContext(), CrowdCount.class);
        startActivity(intent);
    }*/
}